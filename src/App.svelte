    ...
    <ul class="space-y-2">
      {#each pages as page, index (page)}
        <li>
          ...
          <button class="ml-auto bg-gray-800 text-red-500 px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-gray-900" on:click={() => deletePage(index)}>Delete</button>
        </li>
      {/each}
