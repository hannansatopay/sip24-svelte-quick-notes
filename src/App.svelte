...
<!-- <script>
 ...
 <main class='p-4 ml-60 h-auto'>
   ...
   <div class="grid grid-cols-2 items-center mb-3">
     ...
     <button class='ml-auto bg-gray-800 text-white px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-gray-900'
     on:click={saveNote}>Save</button>
   
   </div>
   <hr/>
   
   <textarea class='mt-3 block w-full bg-gray-50 border border-gray-300 rounded-lg text-gray-900 p-2.5' 
