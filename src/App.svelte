<script>
  ...
  function deletePage() {
    ...
    const storedPageName = pages[currentPageIndex];
    localStorage.removeItem(storedPageName);
    const newPages = pages.filter((element) => element != storedPageName);
...
<main class="p-4 ml-60 h-auto">
  <div class="flex justify-between items-center mb-3">
    ...
    <div>
      <button
        class="bg-gray-800 ml-auto text-white px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-gray-900"
