...
<main class="p-4 ml-60 h-auto">
  <div class="grid grid-cols-2 items-centre mb-3">
    ...
    <button class="text-centre ml-auto bg-red-600 text-white px-5 py-2.5 round-lg font-medium  rounded-lg text=sm mt-3 hover:bg-gray-900"on:click={deleteNote}>delete</button>
  </div> 
    <hr/>
