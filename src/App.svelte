  ...
  <div class="bg-light-gray overflow-y-auto py-5 px-3 h-full border-r border-gray-200">
    <ul class="space-y-2">
      ...
      <li>
        ...
        <button on:click={()=>selectPage(index)} class="{index == CurrentPageIndex ? 'bg-dark-gray': 'bg-light-gray'} py-2 px-3 text-gray rounded-lg">{page}</button>
...
<main class="p-4 ml-60  h-auto">
  <div class="grid grid-cols-2 imtems-center mb-4">
    ...
    <button class="ml-auto bg-red-800 text-white px-5 py-2.9 rounded-lg font-medium text-sm mt-3 hover:bg-red-400" on:click={saveNote}>save</button>
