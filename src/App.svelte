<script>
  ...
  // let name = 'CXhinmay Pimpalgaonkar';   //var, let or const
  let pages = [];
...
<main class="p-4 ml-60 h-auto">
  <div class="grid grid-cols-2 items-center mb-3">
    ...
    <!-- <button class="ml-auto bg-red-600 text-white px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-red-900" on:click={deletePage}>Delete</button> -->
  </div>
  <hr/>
