...
<aside class="fixed top-0 left-0 z-40 w-60 h-screen">
  <div
    class="bg-light-gray overflow-y-auto px-3 py-5 h-full border-r border-gray-200"
  >
    <ul class="space-y-2">
...
<main class="p-4 ml-60 h-auto">
  <div class="grid grid-cols-2 items-centre mb-3">
    ...
    <button
      class="ml-auto bg-gray-800 text-white px-5 py-2.5 mt-3 rounded-lg font-medium text-sm hover:bg-gray-900"
      on:click={saveNote}
    >
      Save
    </button>
