<script>
  ...
  function deletePage(index) {
    ...
    if (currentPageIndex === index) {
      selectPage(0); // Select the first page if the current page is deleted
    }
...
<main class="p-4 ml-60 h-auto">
  <div class="grid grid-cols-2 items-center mb-3">
    <h1 class="text-3xl font-bold w-full h-10 leading-10" contenteditable bind:textContent={title}></h1>

    <div class="flex justify-end"> <!-- Aligns items to the right -->
