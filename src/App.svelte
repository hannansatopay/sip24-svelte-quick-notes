...
<aside class="fixed top-0 left-0 z-40 w-60 h-screen">
  <div
    class="bg-light-blue overflow-y-auto py-5 px-3 h-full border-r border-gray-200"
  >
    <ul class="space-y-2">
...
<main class="p-4 ml-60 h-auto font-serif">
  <div class="grid grid-cols-2 items-center mb-3">
    ...
    ></h1>
    <button
      class="ml-auto bg-dark-blue text-white px-5 py-2.5 rounded-lg font-medium text-sm mt-3 hover:bg-darker-blue"
  ...
  <textarea
    class="mt-3 block w-full bg-gray-50 border border-gray-300 rounded-lg text-gray-900 p-2.5 font-serif"
    bind:value={note}
  ></textarea>
</main>
